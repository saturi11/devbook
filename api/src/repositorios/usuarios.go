...
// Buscar traz todos os usuarios que atendem ao filtro especificado
...
func (repositorio Usuarios) BuscarPorID(ID uint64) (modelos.Usuario, error) {
	linhas, erro := repositorio.db.Query(
		"select id, nome, nick, email, criadoEm from usuarios where id LIKE ? ",
		ID,
	)
	if erro != nil {
...
// BuscarPorEmail autentica um usuario do sistema pelo email e senha contidos no banco
...
// BuscarSeguidores permite buscar todos os usuarios seguidos por um
...
// Buscar senha traz a senha de um usuario pelo id
...
// AtualizarSenha salva a nova senha do usuario no banco
