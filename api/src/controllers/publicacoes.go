...
// CriarPublicacoes adiciona uma publicacao no banco de dados
func CriarPublicacoes(w http.ResponseWriter, r *http.Request) {
	...
	//atribui ao autor_id o id do usuario recebido atravez do token
	publicacao.AutorID = usuarioID

	//chama a funcao que faz a validacao dos campos da publicacao
...
// BuscarPublicacoes traz as publis que aparecerao no feed do usuario
func BuscarPublicacoes(w http.ResponseWriter, r *http.Request) {
	...
	//chama a funcao Buscar do repositorio e passa para ela o usuario que veio da req
	repositorio := repositorios.NovoRepositorioDePublicacoes(db)
...
func BuscarPublicacao(w http.ResponseWriter, r *http.Request) {
	//extrai o id da publicacao que foi passado na uri da req e converte para base 10 64 bits
